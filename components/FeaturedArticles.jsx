...
import image1 from "../public/assets/images/Featured.jpg";
    ...
    <div className="pt-10 cursor-pointer">
      ...
      >
        <div className="py-12 bg-[#00000040]">
          <h1 className="text-xl font-serif font-semibold capitalize text-white text-center  ">
            Featured Articles
          </h1>
          ...
          <div className=" container md:w-[90%] mx-auto flex flex-col gap-4 md:flex-row ">
            ...
            <div className='absolute cursor-pointer top-0 left-0 bg-[#00000052] w-full h-full  rounded-lg'></div>
                ...
                <div className="absolute bottom-[16px] left-[22px] w-36 h-autp bg-[#00b1ff99] transition-all hover:scale-90  py-1">
                  <p className="text-white text-[16px] font-serif capitalize text-center my-auto">
                    Family Travel
                  </p>
                </div>
              </div>
              {/* content */}
              <div className="container flex flex-col gap-2 bg-white rounded-b-lg">
                  <h1 className="text-lg text-gray-800 font-serif font-medium capitalize transition-all hover:text-[#00b1ff99] ">
                    The must See Attraction of Argentina
                  </h1>
                  <p className="text-[16px] pb-4 text-gray-700 font-serif flex gap-3 items-center font-medium capitalize">
                    George Steven  <span className="text-sm text-gray-500">June 26,2017  </span>     
                  </p>
                </div>
            </div>
            <div className="flex flex-col  w-full  md:w-[282px] ">
