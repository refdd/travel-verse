...
function SliderReviews() {
   const [sceenWidth, setScreenWidth] = useState(false)
   ...
   useEffect(() => {
    const handleResize = () => {
        ...
        setwidthFull(window.innerWidth)
    };
  ...
  const settings = {
    ...
    infinite: true,
    speed: 500,
    slidesToShow:sceenWidth ? 1 : 3,
    slidesToScroll:sceenWidth ? 1 : 3,
  ...
  return (
    <div className="">
      <Slider {...settings}>
        ...
        <div>
          <div className="">
            <div className="flex flex-col gap-4 px-4 py-2 border-2  shadow-xl rounded-lg">
              {/* avtare and icon */}
