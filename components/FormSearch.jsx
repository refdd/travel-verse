  ...
  return (
    ...
    <div className='container mx-auto  pt-5 md:w-[80%] md:pt-0 md:relative'>
       ...
       <h4 className='mb-4 text-lg font-Roboto font-medium capitalize'>find the place it suits you best</h4>
        ...
        <button type="button" className="w-[127px] text-white bg-[#00AEFF] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  focus:outline-none ">search</button>
        </div>
       </div>
    </div>
  )
